...
def lcm(num1,num2):
    ...
    if num1 > 0 and num2 > 0 :
        ...
        return ("Value Error!!   Please Enter Positive Numbers")
...
def calculate():
    if request.method == "POST":
        ...
        return render_template("result.html", result1 = num1, result2 = num2, lcm = lcm(int(num1),int(num2)), developer_name = 'Ramicho')
    else:
        return render_template("result.html", developer_name = "Ramicho")
